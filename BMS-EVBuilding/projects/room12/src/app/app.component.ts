...
export class AppComponent {
  ...
  public sensors: any[] = ["Proximity", "Light", "Temperature"];
  ...
  public ports: any[] = ["KNX", "Ethernet", "Micro-USB"];
  
  public licenses: string[] = ["Smartphone Control"];
